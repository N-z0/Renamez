...
class Summary_Object:
	...
	def set_metadata(self,metadata):
		...
		### WARNING!!! this function delete the file and ContentType,StorageClass
		self.object.put(Metadata=metadata)
...
class Bucket:
	...
	def get_all_objects(self):
		...
		return [ Summary_Object(o) for o in self.bucket.object_versions.all() ]
	...
	def get_object(self,pathname):
		...
		return Object(self.bucket.Object(pathname))	
	...
	def delete_file(self,item):
		"""delete(set a delete mark) for distant S3 bucket file"""
		response = self.bucket.delete_objects( Delete={'Objects':[{'Key':item}],'Quiet':True} )
		#print("detete mark set for ",item)
